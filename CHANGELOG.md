...
- Правило [`selector-max-compound-selectors`](https://stylelint.io/user-guide/rules/selector-max-compound-selectors/) с запретом уровня сложности составных селекторов выше 2. Сложносоставные селекторы — это те, что ошибочно называют селекторами потомка или вложенности. Ошибочно, потому что любые комбинаторы повышают уровень сложности составного селектора, включая `+` и `~`, которые «не увеличивают вложенность».
